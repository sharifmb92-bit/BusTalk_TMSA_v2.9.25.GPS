// medbasha - Lógica de BusTalk v2.9.25_GPS (Algoritmo SAE/Validadora)
...
function busTalkApp() {
    return {
        ...
        // ALGORITMO TIPO VALIDADORA SAE DE A BORDO (RADIO 150M Y UBRAL < 8 KM/H)
        comprobarLlegadaMarquesina(lat, lng, velocidadKmh) {
            for (let parada in this.coordenadasParadas) {
                ...
                // Perímetro SAE ampliado a 150 metros para capturar el entorno oficial de la parada
                if (dist < 150 && this.misParadasArray.includes(parada)) {
                    ...
                    // Caso B: Entra en la geocerca de la marquesina y frena (< 8 km/h por 2s)
                    else if (velocidadKmh < 8) {
